...
def safe_get(row, keys, default=""):
    """Busca valores em colunas, aceitando pequenas variações de nome."""
...
# ===========================================================
# ✅ CARREGAR DADOS DIRETO DO EXCEL
# ===========================================================
...
try:
    ...
    st.error(f"❌ Não foi possível carregar o arquivo Job Profile.xlsx: {e}")
    st.stop()
...
if selected_labels and len(selected_labels) > 0:
    ...
    # Seções (com variações reconhecidas)
    SECTIONS = [
