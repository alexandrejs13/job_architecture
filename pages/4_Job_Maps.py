...
from utils.ui_components import section, lock_sidebar # Mantido, mas não usado para o header
...
.topbar {
    ...
    margin-bottom: 20px;
    border-radius: 8px;
    box-shadow: 0 2px 8px rgba(0,0,0,0.05); /* Adicionado sombra sutil */
}
...
# NOVO HEADER PADRÃO (Substitui section("🗺️ Job Map"))
st.markdown("""
...
if not st.session_state.fullscreen:
    # A topbar é mantida, mas ajustada para o novo layout sem o 'section'
    ...
    with c3:
        st.write("")
        # Ajustado o margin-top para alinhar o botão com o selectbox
