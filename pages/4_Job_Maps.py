...
st.set_page_config(
    page_title="Job Map", 
    page_icon="🗺️", # Mantido o emoji no page_icon para a aba do navegador
    layout="wide"
)
...
.page-header img { width: 48px; height: 48px; } /* Reativado o estilo img */
        ...
        for (f, sf), c_idx in subfamilias_map.items():
            ...
            for row in records:
                ...
                cards_html.append(
                    ...
                    f"<b>{row['Job Profile']}</b><span>{row
