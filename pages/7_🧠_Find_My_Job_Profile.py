...
with st.spinner("🔄 Preparando base local para busca de cargos..."):
...
if buscar and query.strip():
    ...
    st.markdown("---")
    st.markdown(f"### 🎯 Cargo mais compatível: **{row.get('Job Profile','-')}**  (similaridade: {score:.1%})")
